...
def tracing_line(indent, current_group, frame=False):
    ...
    # "watchvars" could be implemented instead of "print" :)
    # print(locals()) somehow gives just [object Object], so I workedaround
    # ps.: initial (system) locals/globals should be excluded of course
